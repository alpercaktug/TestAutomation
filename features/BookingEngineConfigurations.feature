Feature: Booking Engine Configurations
  ...
  Scenario: Auto-Confirm Paid Reservations enabled
    ...
    When I make a reservation for a "King Suite" for 1 night and 1 adult with "Mail order"
  ...
  Scenario Outline: Auto Confirm All Reservations enabled
    ...
    When I make a reservation for a "King Suite" for 1 night and 1 adult with "<Payment Method>"
    Then I should see the reservation is "Confirmed"
  ...
  Scenario Outline: Auto Confirm All Reservations disabled
    ...
    When I make a reservation for a "Classic Room" for 1 night and 1 adult with "<Payment Method>"
    Then I should see the reservation is "Reserved"
  ...
  Scenario: Best Available Rate enabled
  ...
  Scenario: Best Available Rate disabled
    Given that the "Best Available Rate" setting is "disabled"
    When I search for an available room for 1 night and 1 adult
    Then I shouldn’t see a recommended best available rate
  ...
  Scenario: Display Coupon Code as Name enabled
    ...
    When I make a reservation with the coupon code
    Then I should see the coupon name on the reservation details
    And verify that the coupon discount is successful

  Scenario: Display Coupon Code as Name disabled
    Given that the "Display Coupon Code as Name" setting is "disabled"
    And I have a coupon code
    When I make a reservation with the coupon code
    Then I should see the coupon code on the reservation details
    And verify that the coupon discount is successful
